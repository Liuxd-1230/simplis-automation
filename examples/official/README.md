# Official SIMPLIS Examples

These files are official SIMPLIS examples approved for inclusion in this open-source skill. They provide evidence for symbol names, reusable modules, schematic structure, probes, and simulation artifacts.

## Included Examples

- `SIMPLIS_Buck_Converter/SIMPLIS_Buck_Converter.sxsch`: baseline SIMPLIS buck converter example.
...
Do not add private research schematics to this directory. If a file is not clearly an official example, ask before copying it into the repository.
